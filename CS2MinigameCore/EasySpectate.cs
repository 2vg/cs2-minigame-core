...
namespace CS2MinigameCore
{
    public class EasySpectate
    {
        ...
        public EasySpectate(CS2MinigameCore plugin, bool hotReload)
        {
            m_CSSPlugin = plugin;
        ...
        public CCSPlayerController? GetClientAimTarget(CCSPlayerController player)
        {
            ...
            VirtualFunctionWithReturn<nint, nint, nint> findPickerEntity = new(GameRules.Handle, OFFSET_CGameRules_FindPickerEntity);
