...
namespace CS2MinigameCore
{
    public class ScreenShakeEvent : OmikujiEvent
    {
        ...
        public void execute(CCSPlayerController client)
        {
            ...
            if (shakeEnt == null)
            {
                CS2MinigameCore.getInstance().Logger.LogError("Failed to create env_shake!");
                return;
            }
            ...
            foreach (CCSPlayerController cl in Utilities.GetPlayers())
            {
                ...
                cl.PrintToChat($"{Omikuji.CHAT_PREFIX} {CS2MinigameCore.getInstance().Localizer["Omikuji.MiscEvent.ScreenShakeEvent.Notification.PrepareForImpact", client.PlayerName]}");
            }
