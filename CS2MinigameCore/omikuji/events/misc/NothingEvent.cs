    ...
    public class NothingEvent : OmikujiEvent
    {
        ...
        public void execute(CCSPlayerController client)
        {
            ...
            foreach (CCSPlayerController cl in Utilities.GetPlayers())
            {
                ...
                cl.PrintToChat($"{Omikuji.CHAT_PREFIX} {Omikuji.GetOmikujiLuckMessage(omikujiType, client)} {CS2MinigameCore.getInstance().Localizer["Omikuji.MiscEvent.NothingEvent.Notification.ButNothingHappened"]}");
            }
        }
