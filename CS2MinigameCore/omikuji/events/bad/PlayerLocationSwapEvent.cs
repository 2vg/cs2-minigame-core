    ...
    public class PlayerLocationSwapEvent : OmikujiEvent
    {
        ...
        public void execute(CCSPlayerController client)
        {
            ...
            if (alive.Count <= 1)
            {
                ...
                Server.PrintToChatAll($"{Omikuji.CHAT_PREFIX} {Omikuji.GetOmikujiLuckMessage(omikujiType, client)} {CS2MinigameCore.getInstance().Localizer["Omikuji.BadEvent.PlayerLocationSwapEvent.Notification.Avoided", client.PlayerName]}");
                return;
            }
            ...
            Server.PrintToChatAll($"{Omikuji.CHAT_PREFIX} {Omikuji.GetOmikujiLuckMessage(omikujiType, client)} {CS2MinigameCore.getInstance().Localizer["Omikuji.BadEvent.PlayerLocationSwapEvent.Notification.LocationSwapping"]}");
        }
