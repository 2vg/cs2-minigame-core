    ...
    public class GiveRandomItemEvent : OmikujiEvent
    {
        ...
        public void execute(CCSPlayerController client)
        {
            ...
            foreach (CCSPlayerController cl in Utilities.GetPlayers())
            {
                ...
                cl.PrintToChat($"{Omikuji.CHAT_PREFIX} {Omikuji.GetOmikujiLuckMessage(omikujiType, client)} {CS2MinigameCore.getInstance().Localizer["Omikuji.LuckyEvent.GiveRandomItemEvent.Notification.ItemReceived", randomItem]}");
            }
        ...
        public void initialize()
        {
            ...
            CS2MinigameCore.getInstance().AddTimer(0.01F, () =>
            {
                ...
                CS2MinigameCore.getInstance().RegisterEventHandler<EventPlayerSpawn>((@event, info) =>
                {
