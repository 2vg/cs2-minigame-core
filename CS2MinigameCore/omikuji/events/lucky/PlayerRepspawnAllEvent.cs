        ...
        public void execute(CCSPlayerController client)
        {
            ...
            if (alivePlayer == null)
            {
                ...
                foreach (CCSPlayerController cl in Utilities.GetPlayers())
                {
                    ...
                    cl.PrintToChat($"{Omikuji.CHAT_PREFIX} {Omikuji.GetOmikujiLuckMessage(omikujiType, client)} {CS2MinigameCore.getInstance().Localizer["Omikuji.LuckyEvent.PlayerRespawnAllEvent.Notification.NoOneAlive"]}");
                }
                return;
            }
            ...
            foreach (CCSPlayerController cl in Utilities.GetPlayers())
            {
                ...
                cl.PrintToChat($"{Omikuji.CHAT_PREFIX} {Omikuji.GetOmikujiLuckMessage(omikujiType, client)} {CS2MinigameCore.getInstance().Localizer["Omikuji.LuckyEvent.PlayerRespawnAllEvent.Notification.Respawn"]}");
