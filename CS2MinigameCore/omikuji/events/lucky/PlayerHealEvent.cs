...
namespace CS2MinigameCore
{
    public class PlayerHealEvent : OmikujiEvent
    {
        ...
        public void execute(CCSPlayerController client)
        {
            ...
            if (isPlayerAlive)
            {
                msg = $"{Omikuji.CHAT_PREFIX} {Omikuji.GetOmikujiLuckMessage(omikujiType, client)} {CS2MinigameCore.getInstance().Localizer["Omikuji.LuckyEvent.PlayerHealEvent.Notification.Healed", client.PlayerName, PluginSettings.getInstance.m_CVOmikujiEventPlayerHeal.Value]}";
            }
            else
            {
                msg = $"{Omikuji.CHAT_PREFIX} {Omikuji.GetOmikujiLuckMessage(omikujiType, client)} {CS2MinigameCore.getInstance().Localizer["Omikuji.LuckyEvent.PlayerHealEvent.Notification.PlayerIsDead", client.PlayerName]}";
            }
