...
namespace CS2MinigameCore
{
    public class VoteMapRestart
    {
        ...
        public VoteMapRestart(CS2MinigameCore plugin)
        {
            m_CSSPlugin = plugin;
        ...
        private void CommandVoteRestartMap(CCSPlayerController? client, CommandInfo info)
        {
            ...
            if (isMapRestarting)
            {
                ...
                client.PrintToChat(CS2MinigameCore.MessageWithPrefix(m_CSSPlugin.Localizer["VoteMapRestart.Command.Notification.AlreadyRestarting"]));
                return;
            }
            ...
            if (Server.EngineTime - mapStartTime > PluginSettings.getInstance.m_CVVoteMapRestartAllowedTime.Value)
            {
                ...
                client.PrintToChat(CS2MinigameCore.MessageWithPrefix(m_CSSPlugin.Localizer["VoteMapRestart.Command.Notification.AllowedTimeIsEnded"]));
                return;
            }
            ...
            if (votedPlayers.Contains(client))
            {
                ...
                client.PrintToChat(CS2MinigameCore.MessageWithPrefix(m_CSSPlugin.Localizer["VoteMapRestart.Command.Notification.AlreadyVoted"]));
                return;
            }
            ...
            Server.PrintToChatAll(CS2MinigameCore.MessageWithPrefix(m_CSSPlugin.Localizer["VoteMapRestart.Notification.PlayerVote", client.PlayerName, votedPlayers.Count(), playersRequiredToRestart]));
        ...
        private void InitiateMapRestart()
        {
            ...
            Server.PrintToChatAll(CS2MinigameCore.MessageWithPrefix(m_CSSPlugin.Localizer["VoteMapRestart.Notification.MapRestart", PluginSettings.getInstance.m_CVVoteMapRestartRestartTime.Value]));
